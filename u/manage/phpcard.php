...
$a=mb_detect_encoding($ptkana, "JIS, SJIS, EUC-JP, UTF-8,EUC-JP_win");

print $a;

$foo2 = mb_convert_kana($ptkana, "k", $a);

print $foo2;
print "MMMM";

$foo3 = mb_convert_encoding($foo2, "EUC-JP",mb_detect_encoding($foo2, "JIS, SJIS, EUC-JP, UTF-8,EUC-JP_win"));



print $foo3;

$foo4 = mb_convert_encoding($foo2, "SJIS",mb_detect_encoding($foo2, "JIS, SJIS, EUC-JP, UTF-8,EUC-JP_win"));


print mb_detect_encoding($foo4, "JIS, SJIS, EUC-JP, UTF-8,EUC-JP_win");
print $foo4;
print "GGGGGGGGGGGGG";
...
$denbun=$heads.$ptids.$spaces.$foo4.$ptdobs.$ptsexs.$fookanji.$crs;
