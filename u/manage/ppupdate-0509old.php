...
SELECT * FROM otatest_order
	...
	where patient=$ptid   and order_date <CAST('$ordate' AS DATE) + CAST('-30 days' AS INTERVAL) and "Superseded" is null  order by order_date desc	 limit 1
...
if ( $kkvar != 'k103' && $kkvar != 'k1006' && $kkvar != 'k1007'){
//print $kkvar."=";
$val=$attrval[$kkvar];
//print $val."val";
 if ($val !=''){
