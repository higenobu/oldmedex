...
//0328-2012
if ($uketuke ==2){
$query='SELECT p."患者ID", p."姓", p."名", p."フリガナ", p."入外区分", p."入院日", p."退院予定日", p."病室", o."ObjectID", o."処方年月日", o."処方開始日",u."受付時刻",u."ステータス" o."記録者" as "指示医"  FROM "薬剤処方箋" as  o LEFT JOIN "患者台帳" p ON o."患者" = p."ObjectID" JOIN "受付患者表"  u ON o."患者"=u."患者" WHERE o."Superseded" IS NULL ';
}
else {
$query='SELECT  distinct(o."ObjectID"),p."患者ID", p."姓", p."名", p."フリガナ", p."入外区分", p."入院日", p."退院予定日", p."病室", o."処方年月日", o."処方開始日",s."姓"||s."名" as "指示医" FROM "薬剤処方箋" as  o LEFT JOIN "患者台帳" p ON o."患者" = p."ObjectID" LEFT JOIN "職員台帳" s ON s."ID"=o."記録者" WHERE o."Superseded" IS NULL ';
}
...
p."入院日", p."退院予定日", p."病室", o."処方年月日", o."処方開始日",o."記録者" FROM "薬剤処方箋" as  o 
