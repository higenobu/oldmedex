...
<html><head><meta http-equiv="content-type" content="text/html; charset=euc-jp"><link rel="shortcut icon" href="/resource/29017a23/favicon.ico">
<script language="JavaScript" src="/resource/29017a23/AC_OETags.js"></script>
<script language="JavaScript" src="/resource/29017a23/mx.js"></script>
<script language="JavaScript" src="/resource/29017a23/PopupWindow.js"></script>
<script language="JavaScript" src="/resource/29017a23/date.js"></script>
<script language="JavaScript" src="/resource/29017a23/CalendarPopup.js"></script>
<script language="JavaScript" src="/resource/29017a23/AnchorPosition.js"></script>
<script language="JavaScript" src="/resource/29017a23/MochiKit.js"></script>
<script language="JavaScript" src="/resource/29017a23/post_code.js"></script>
<script language="JavaScript" src="/resource/29017a23/inc_search_sjis.js"></script>
<script language="JavaScript" src="/resource/29017a23/vocabulary.js"></script>
<script language="JavaScript" src="/resource/29017a23/apptcal.js"></script>
<script language="JavaScript" src="/resource/29017a23/drawapp-js.php"></script>
<link rel="stylesheet" href="/resource/29017a23/mxstyle.css" />
<link rel="stylesheet" href="/resource/29017a23/calend.css" />
<link rel="stylesheet" href="/resource/29017a23/qxr.css" />
<title>DOCKTemlate</title>
</head>
	<body>
...
$query='SELECT temp2 from wktemp where kubun=1';
...
// -->
    ...
    <h1>report</h1>
    <form action="lcmtempdb.php" method="POST">
...
<tbody>
 <tr>
<th>Exam Date</th><td colspan="7">
<script>var calend = new MedexCalendarPopup("abc");</script>
<div id="abc" class="soecal" style="position:absolute; visibility:hidden"></div>
<input type="text" size="10" onKeyPress="return disableEnterKey(this,event)" id="eee" name="kenshindate" value="">
<a href="#" onclick="calend.select(document.getElementById('eee'),'anchor-eee', 'yyyy-MM-dd'); return false;" id="anchor-eee" name="anchor-eee" >*</a></div></td> 
 </tr>
...
echo("<option value=".'"'.
htmlspecialchars($row2['temp2']).'"'.">".htmlspecialchars($row2['temp2']).
" </option>\n");	 
...
echo("<option value=".'"'.
htmlspecialchars($row['temp2']).'"'.">".htmlspecialchars($row['temp2']).
" </option>\n");	 
...
<td class="plain">body</td>
 ...
 <td class="plain"><input type="checkbox" name="a"  value="a">a<input type="checkbox" name="b" value="b">b</td>
