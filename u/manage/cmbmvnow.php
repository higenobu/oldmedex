...
/*
$sel100 = <<<SQL
	select cmbcode, medexcode from  cmbmaster          
SQL;

 
 

$rows1 =  mx_db_fetch_all($db, $sel100);
  $itemcd = array();
  foreach($rows1 as $row)
 {
 
$itemcd[$row['cmbcode']]=$row['medexcode'];
//echo $row['cmbcode']."=".$itemcd[$row['cmbcode']]."<br>";
...
if ($dir = opendir("/home/medex/cmbtest4")) {
    while (($file = readdir($dir)) !== false) {
        if ($file != "." && $file != "..") {
//            echo "$file\n";
   
$dir1="/home/medex/cmbtest4/";
$filename = $dir1.$file;
...
//	echo $name . "<br />\n";
	...
	$wkijun1=$info[7];
	$stmt = <<<SQL
	insert into test_resultwkcmb(karteno, testdate,ptname,komokucode,kname,kekka,unit,kijun1,sw) 	
	values 	('$kno','$wodate','$wptname','$code','$name','$value','$wunit','$wkijun1','0')
SQL;
//echo $stmt . "<br />\n";
if (pg_query($db, $stmt)){
//echo $info[1] . "<br />\n";
...
print '<p>  read files and inserted into wkdb COMPLETED </p>';
