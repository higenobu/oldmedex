...
<script type="text/javascript">
    function winOpen(){
        ...
        mywind1=window.open("../doctor/xctorder2-app.php?SetPatient=1&PatientID=00001007","width=640,height=640");
 //	window.open("tablev.php");
    }
</script>
 
<a href='javascript:winOpen();'>ウィンドウを開く</a>
<a href="javascript:void(0)" onclick="window.close();">SELF閉じる</a>
<br />
	<body>
...
<br>
<a href=content1.php>コンテンツその１へ</a><br>
<a href=content2.php>コンテンツその２へ</a><br>
 
<?php
 

if ($_POST['dbname'] == "java") {
	print '<SCRIPT LANGUAGE="JavaScript">
   winOpen();
  </SCRIPT>';
	exit;
}
if ($_POST['dbname'] == "javaend") {
	print '<SCRIPT LANGUAGE="JavaScript">
   mywind1.close();
  </SCRIPT>';
	exit;
