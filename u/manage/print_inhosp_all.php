...
$stmt='SELECT   rx_id FROM rx_temp  where "Superseded" is null and selected = 1 ';
...
//foreach end
  ...
  print '<frameset rows="55, *" noresize border="0">
         <frame src="print_inhosp_all.php?top=1" name="top_frame" scrolling="no">
         <frame src="print_inhosp_all.php?bottom=1&';
