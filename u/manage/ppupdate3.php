...
SELECT * FROM otatest3_order
	...
	where patient=$ptid   and order_date<(CAST('$topdate' AS DATE) + CAST('-30 days' AS INTERVAL)) and
 "Superseded" is null  order by order_date desc	 limit 1
