...
$cond11=' where xct."Superseded" is null and xct."患者" !=32834    and xct."患者" !=32683 and stop is null and ';	
$cond31="(";
$cond32=")";
$cond33=" or ";

$cond01 = "   procdate >=  date'today' - ";
$cond21 = "   plandate >=  date'today' - ";

$cond02 = $_POST[plusdate];

$cond03 = " and procdate <= date'today' + ";
$cond23 = " and plandate <= date'today' + ";
$cond04 = $_POST[plusdate2];
//$cond05="  and xct.\"Superseded\" is null";
if ($_POST[proof]=='N')
{
$cond06="  and xct.proof is null";
$query = $query.$cond11.$cond21.$cond02.$cond23.$cond04.$cond06;
}
else {	
if ($_POST[proof]==null)
{
$cond06="  ";
$query = $query.$cond11.$cond31.$cond21.$cond02.$cond23.$cond04.$cond32.$cond33.$cond31.$cond01.$cond02.$cond03.$cond04.$cond32.$cond06;
}
else 
{
$cond06="  and xct.\"proof\" =";
$cond07= "'".$_POST[proof]."'";
$query = $query.$cond11.$cond01.$cond02.$cond03.$cond04.$cond06.$cond07;
...
{
$inoutcond=' and  p."入外区分"='."'".$inout."'";
}

$kubuncode=$_POST[kubun];
...
{
$kubuncond=' and  "xctkubun"='."'".$kubuncode."'";
}



//0615-2011  	
$query = $query.$inoutcond.$kubuncond."  order by plandate desc  limit 1000";
 ...
 */
		...
		if ($col == 5){ 
				...
				if ($rowdata[$col]=='O') {$rowdata[$col]='外来';}
				if ($rowdata[$col]=='I') {$rowdata[$col]='入院';}
