...
<link rel="stylesheet" href="/resource/8a783773/qxr.css" />
		...
		<title>RX selected</title>
	</head>
	<body>
<a href="index.php?tab=1">メインに戻る</a>
<br>

<a href="rxselectedprint2.php?">定期処方箋印刷</a>
<br>
...
$query1 = $query1.$cond01.$cond02.$cond03.$cond04.$cond05.$cond06.$cond07.$cond08.$cond09.$cond10.$condtest;
...
if (!$rs1) {
	...
	pg_close($con);
	echo("<p><span style=\"color:red\">rx_temp2 table failed </span></p>\n");
	echo("</body></html>\n");
	exit;
}
//***************************
...
$query='select 
            rx_id, pt_num, pt_last, pt_first, pt_kana, nyugai, indate, outdate, teiki,
            room, orderdate, startdate , pt_id, selected from rx_temp2 order by   rx_id  desc limit 1000';
...
<a href="rxselectedprint2.php?tab=1">定期処方箋印刷</a>
<br>
	</body>
