...
//
  print "<td><button type=\"submit\" style=\"height:50\"  name='print2' value=\"$oid\">処方箋印刷2</button></td>\n";
    ...
    if ($_mx_rx_print)
      print "<td><button type=\"submit\" style=\"height:50\"  name='print' value=\"$oid\">処方箋印刷</button></td>\n";
    print "</tr></table>";
    print "<table>";
