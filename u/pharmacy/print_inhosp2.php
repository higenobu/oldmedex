...
//1117-2011
$PatientRoom=s($data['PatientRoom']);
$Kaishibi=s($data['Kaishibi']);
$Teiki=s($data['Teiki']);
...
$data['Kaishibi'] = mx_wareki($ord['処方開始日']);
...
//bottom
  ...
  print '<frameset rows="55, *" noresize border="0">
         <frame src="print_inhosp2.php?top=1" name="top_frame" scrolling="no">
         <frame src="print_inhosp2.php?bottom=1&';
