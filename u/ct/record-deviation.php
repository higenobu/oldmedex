...
class ct_record_deviation_application extends single_table_application {
  var $use_single_pane = 1;
	...
	function object_edit($prefix) {
		return new ct_record_deviation_edit($prefix, &$this);
	}

}

$main = new ct_record_deviation_application();
$main->main();
?>
