...
function mx_draw_ppa_applist($patient_id) {
	...
	print "<span id='ppa-list-here'$triggers$ul>¥¢¥×¥ê¥±¡¼¥·¥ç¥ó</span>";
...
(
	...
	'ENABLE_QBE' => array(array('Column' => '´µ¼ÔID','Label' => "PID",
			      ...
			      array('Column' => '¥Õ¥ê¥¬¥Ê','Label' => "nickname",
				    'Compare' => 'P."¥Õ¥ê¥¬¥Ê"',
...
//
	...
	'LCOLS' => array(array('Column' => '´µ¼ÔID','Label' => "PID",
			 ...
			 array('Column' => "¼ç¼£°åÀ«Ì¾",
			       'Option' => array('Class' => 'nowrap'),
			       'Label' => "mainDr"),
			 array('Column' => 'Á°²óÍè±¡»þ¹ï','Label' => "previousvisit",
			       'Option' => array('Class' => 'nowrap')),
//0116-2014
array('Column' => 'À«','Label' => "Last name",
			       'Option' => array('Class' => 'nowrap')),
	...
	'UNIQ_KEY' => 'P."ObjectID"',
//0110-2014 need to change to english
	'LLAYO' => array(array('Column' => '´µ¼ÔID', 'Label'=>'PID',),
			 ...
			 array('Column' =>"Ç¯Îð",'Label'=>'Age',),
			  //
			  //
			 array('Column' => "Á°²óÍè±¡»þ¹ï",'Label'=>'Lastvisit',
			       'Draw' => 'timestamp',
...
SELECT C."ObjectID", C."CreatedBy", C."´µ¼Ô", C."´µ¼ÔID", "checkin",
	C."¼õÉÕ»þ¹ï", C."Í½Ìó»þ¹ï", C."À«", C."Ì¾",
	(C."À«" || ' ' || C."Ì¾") AS "À«Ì¾", C."¥Õ¥ê¥¬¥Ê", C."ÌÜÅª",
...
WHERE
C."Superseded" IS NULL and (("¼õÉÕ»þ¹ï">= CURRENT_DATE -100 ) OR
(C."Í½Ìó»þ¹ï" IS NULL OR C."Í½Ìó»þ¹ï" >= CURRENT_DATE-50))
...
(
	...
	'ENABLE_QBE' => array(
//0115-2014
// 		array('Column'=>'¼õÉÕ»þ¹ï','Label'=>"Checkin",
 //		'Compare'=>'C."¼õÉÕ»þ¹ï"',),
	array('Column'=>'checkin','Label'=>"CheckinD",
 		'Compare'=>'checkin',),
...
//			      '¼õÉÕ»þ¹ï' => array('¼õÉÕ»þ¹ï' => 'C."¼õÉÕ»þ¹ï"'),
	...
	'DEFAULT_SORT' => 'checkin',
	'SORT_TIEBREAK' => array('C."¼õÉÕ»þ¹ï"', 'P."´µ¼ÔID"'),
	'UNIQ_KEY' => 'C."ObjectID"',
	...
	'LCOLS' => array(
			 ...
			 array('Column' => '´µ¼ÔID','Label' => "PID",
			       'Option' => array('Class' => 'nowrap')),
			 array('Column' => 'À«Ì¾','Label' => "Patient Name",
			       'Option' => array('Class' => 'nowrap')),
//			¡¡ 
			array('Column' => 'checkin','Label' => "CheckinDate",
				 'Draw' => 'date',
			       ),
			 array('Column' => 'ÌÜÅª','Label' => "Package",
			       'Option' => array('Class' => 'nowrap')),
			 array('Column' => "À­ÊÌ",
			       'Compare' => 'P."À­ÊÌ"',
			       'Draw' => 'enum',
			 ...
			 array('Column' => "»ñ¸»",
			       'Option' => array('Class' => 'nowrap'),
			       'Label' => "DR"),
			 array('Column' => "¼õÉÕ»þ¹ï",'Label' => "CheckinTime",
//0115-2014
			       'Draw' => 'timestamp',
			       'Option' => array('to-seconds' => 0, 
						 'Class' => 'nowrap')),
			 array('Column' => "Á°²óÍè±¡»þ¹ï",'Label' => 'Previous visit',
			       'Draw' => 'timestamp',
			       'Option' => array('to-seconds' => 0,
						 'Class' => 'nowrap')),
			  array('Column' => "Í½Ìó»þ¹ï",'Label' => "Appttime",
			      'Draw' => 'timestamp',
			      'Option' => array('to-seconds' => 0,
			 			 'Class' => 'nowrap')),
...
if ($_mx_use_dept_in_reception) {
	...
	$__ppa_cil_eqbe = array('´µ¼ÔID','À­ÊÌ','À«',
				'Ç¯Îð',   
				'Í½ÌóÀè' );
	...
	$__ppa_checkin_list_cfg['LLAYO'] =
		_lib_so_zip_layo($__ppa_checkin_list_cfg['LCOLS'], array
				 ('checkin', '¼õÉÕ»þ¹ï',
				  ...
				  '»ñ¸»',
				  'ÌÜÅª' ));
	$__ppa_cil_eqbe = array('checkin','´µ¼ÔID','À«','Ç¯Îð', 'Í½ÌóÀè');
} else {
	$__ppa_checkin_list_cfg['LLAYO'] =
		_lib_so_zip_layo($__ppa_checkin_list_cfg['LCOLS'], array
				 ($__status, '´µ¼ÔID', '¥Õ¥ê¥¬¥Ê',
				  'ÌÜÅª', 'À­ÊÌ', 'Ç¯Îð',  
				  '»ñ¸»','¼õÉÕ»þ¹ï',
				  
				  'checkin', 'Á°²óÍè±¡»þ¹ï' ));

	$__ppa_cil_eqbe = array('checkin','´µ¼ÔID','À«',  
				'À­ÊÌ', 'Ç¯Îð', 'Í½ÌóÀè');
}
if ($_mx_use_checked_in_patient_status) {
