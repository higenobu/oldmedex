...
(
 ...
 array("Column" => '姓','Label' => '大分類'),
			       
array("Column" => '名','Label' => '中分類'),
array('Column' => 'フリガナ','Label' => '小分類',
			    'Compare' => 'P."フリガナ"',
...
//0325-2013
	'LCOLS' => array(array('Column' => '患者ID','Label' => '分類番号',
			...
			array('Column' => '名', 'Label' => "中分類",
			 ...
			 array('Column' => 'フリガナ', 'Label' => "小分類",
			       'Option' => array('Class' => 'nowrap')),
/*
array('Column' => '勤務先名', 'Label' => "ocupation",
			       'Option' => array('Class' => 'nowrap')),
			 array('Column' => "性別", 'Label' => "コード",
			       'Draw' => 'enum',
			       'Option' => array('Class' => 'nowrap'),
//0328-2013 English
			       'Enum' => array('M' => 'M',
					       'F' => 'F',
					       '' => '')),
array('Column' => '生年月日', 'Label' => "開始日",
			       'Option' => array('Class' => 'nowrap')),
			 array('Column' => '年齢', 'Label' => "期間",
			       'Option' => array('Class' => 'nowrap')),
			 array('Column' => '患者グループ', 'Label' => "Group",
			       'Option' => array('Class' => 'nowrap')),
			 array('Column' => '患者マーク', 'Label' => "Pmark",
			       'Option' => array('Class' => 'nowrap')),
			 array('Column' => "入外区分", 'Label' => "IN/OUT",
			       'Draw' => 'enum',
			       'Option' => array('Class' => 'nowrap'),
//0328-2013 English
			       'Enum' => array('I' => 'IN',
					       'O' => 'OUT',
					       '' => '')),
			 array('Column' => "主治医姓名", 'Label' => "Main DR.",
			       'Option' => array('Class' => 'nowrap'),
			       'Label' => "主治医"),
			 array('Column' => '前回来院時刻', 'Label' => "vsited",
			       'Option' => array('Class' => 'nowrap')),
*/
...
'勤務先名' =>
	...
	'UNIQ_KEY' => 'P."ObjectID"',
//0325-2013
	'LLAYO' => array(array('Column' => '患者ID','Label'=>'分類番号',
			       'Option' => array('Class' => 'nowrap')),
//
array('Column' => '姓', 'Label' => "大分類",
			       'Option' => array('Class' => 'nowrap')),
...
SELECT C."ObjectID", C."CreatedBy", C."患者", C."患者ID",
	...
	(C."姓" || ' ' || C."名") AS "姓名", C."フリガナ",(C."フリガナ" || '') as "furi", C."目的",
...
WHERE C."Superseded" IS NULL $exclude_done AND (C."CreatedBy" IS NULL OR (C."CreatedBy" = 1 AND C."予約時刻" >= (CURRENT_DATE + INTERVAL '1 DAY')))
...
//0925-2013
	'ENABLE_QBE' => array(array('Column' => '患者ID','Label'=>'分類番号',
				    'Compare' => 'C."患者ID"',
				    'CompareMethod' => 'zeropad_exact',
				    'ZeroPad' => $_mx_patient_id_zeropad,
				    'Singleton' => 1,
...
/*
			      array('Column' => "性別",'Label'=>'コード',
				    ...
				    'Enum' => array('M' => 'M',
						    'F' => 'F',
						    '' => '(Both)')),
			      array('Column' => "年齢",'Label'=>'AGE',
				    'Compare' => 'EXTRACT(YEAR FROM AGE(P."生年月日"))',
				    'Draw' => 'text',
				    'Option' => array('size' => 3),
				    ),
			      array('Column' => "患者グループ",'Label'=>'Group',
				    'Compare' => 'P."希望棟"','Label'=>'Tower',
				    'Draw' => 'enum',
				    'Singleton' => 1,
				    'Enum' => 'lazy'),
			      array('Column' => '患者マーク','Label'=>'Pmark',
				    ...
				    'Singleton' => 1,
				    'Enum' => 'lazy'),
			      array('Column' => '主治医','Label'=>'Main Dr.',
				    'Compare' => 'E.employee_id',
				    'Draw' => 'enum',
				    'Singleton' => 1,
				    'Enum' => 'lazy'),
			      array('Column' => '予約先','Label' => 'Reserv',
				    'Draw' => 'enum',
				    'Singleton' => 1,
				    'Enum' => 'lazy'),
			      array('Column' => '科目','Label'=>'Dept',
				    'Compare' => 'D."ObjectID"',
				    'Draw' => 'enum',
				    'Singleton' => 1,
				    'Enum' => 'lazy'),
...
//0925-2013
	'LCOLS' => array(
			 array('Column' => "診療中",
			       ...
			       'Option' => array('Class' => 'nowrap'),
			       'Draw' => 'pt_status'),
			 array('Column' => "受付患者状態", 'Label' => "Status",
			       'Draw' => 'dbenum',
			       'Option' => array('Class' => 'nowrap'),
			       'DBEnum' => array('受付患者状態',
						 '受付患者状態')),
			 array('Column' => '患者ID', 'Label' => "分類番号",
			       'Option' => array('Class' => 'nowrap')),
			 array('Column' => '姓', 'Label' => "大分類",
			       'Option' => array('Class' => 'nowrap')),
			array('Column' => '名', 'Label' => "中分類",
...
//			       'Option' => array('Class' => 'nowrap')),
			 ...
			 array('Column' => "受付時刻", 'Label' => "checktime",
			       ...
			       'Option' => array('to-seconds' => 0,
						 'Class' => 'nowrap')),
			 array('Column' => "前回来院時刻", 'Label' => "visited",
			       'Draw' => 'timestamp',
			       'Option' => array('to-seconds' => 0,
						 'Class' => 'nowrap')),
			 array('Column' => "予約時刻", 'Label' => "Reserved",
			       'Draw' => 'timestamp',
			       'Option' => array('to-seconds' => 0,
						 'Class' => 'nowrap')),
			 //array('Column' => '科目名',
