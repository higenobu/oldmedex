...
function __lib_u_everybody_plansheet_cfg(&$cfg) {
  ...
  $cfg = array_merge
	  ($cfg,
	   array('TABLE' => 'リハ総合実施計画書',
		 'ALLOW_SORT' => 1,
		 'DEFAULT_SORT' => '日付',
		 'LCOLS' => array('日付', '記録者名',
				  '主治医名', 'リハ担当医名'),
		 'ICOLS' => array('患者'),
		 'NO_3WAY_ICOLS' => array('患者'),

		 'UNIQ_ID' => 'PS."ObjectID"'));

  // List of flip-pages COLS elements.
  $basic = array(array('Column' => '日付',
		       'Draw' => 'text',
		 ...
		 array('Column' => "氏名",
		       'Draw' => 'static',
		       '_NO_ICOL_' => 1,
		       '_SQL_SELECT_' => 'P."姓" || \' \' || P."名"'),
		 array('Column' => "性別", 'Draw' => 'static_enum',
		       'Enum' => array('M' => '男', 'F' => '女', '' => '不明'),
		       '_NO_ICOL_' => 1,
		       '_SQL_TABLE_' => 'P'),
		 array('Column' => "生年月日",
		       '_NO_ICOL_' => 1,
  ...
  $basic = array_merge
	  ($basic,
	   array(array('Column' => "診断名",
		 ...
		 array('Column' => "コントロール状態",
		       'Draw' => 'text',
		       'Option' => array('size' => 50,
					 'maxlength' => 40)),
		 array('Column' => "リハビリテーション歴",
		       'Draw' => 'text',
		       'Option' => array('size' => 50,
					 'maxlength' => 40)),
		 array('Column' => "日常生活自立度", 'Draw' => 'enum',
		       'Enum' =>
		       _lib_u_everybody_plansheet_ident_enum
		       ('-','J','A1','A2','B1','B2','C1','C2')),
		 array('Column' => "痴呆性老人の日常生活自立度判定基準",
		       'Label' => "自立度判定基準",
		       'Draw' => 'enum',
		       'Enum' => 
		       _lib_u_everybody_plansheet_ident_enum
  ...
  $flippage = array
    (
     ...
     '心身構造・機能' =>
     array_merge(__lib_u_everybody_plansheet_ps_ct("意識障害"),

		 __lib_u_everybody_plansheet_ps_ct("痴呆", "見当識障害"),
		 __lib_u_everybody_plansheet_ps_ct("記憶障害", "記銘力障害"),
		 __lib_u_everybody_plansheet_ps_ct("運動障害"),
		 __lib_u_everybody_plansheet_ps_ct("表在感覚障害"),
		 __lib_u_everybody_plansheet_ps_ct("深部感覚障害"),
		 __lib_u_everybody_plansheet_ps_ct("摂食機能障害"),
		 __lib_u_everybody_plansheet_ps_ct("排尿機能障害"),
		 __lib_u_everybody_plansheet_ps_ct("排便機能障害"),
		 __lib_u_everybody_plansheet_ps_ct("呼吸循環器機能障害",
						   "呼吸・循環器障害"),


		 __lib_u_everybody_plansheet_ps_ct("構音障害"),
		 __lib_u_everybody_plansheet_ps_ct("関節可動域制限"),
		 __lib_u_everybody_plansheet_ps_ct("筋力低下"),
		 __lib_u_everybody_plansheet_ps_ct("褥創"),
		 __lib_u_everybody_plansheet_ps_ct("痛み"),
		 __lib_u_everybody_plansheet_ps_ct("半側視空間無視"),
		 __lib_u_everybody_plansheet_ps_ct("注意障害", "注意力障害"),
		 __lib_u_everybody_plansheet_ps_ct("構成障害"),

		 array
		 (array('Column' => '心身機能・その他',
			'Draw' => 'textarea',
			'Option' => array('cols' => 50, 'rows' => 6)),
		 ),

		 __lib_u_everybody_plansheet_ps_ihh("寝返り"),
		 __lib_u_everybody_plansheet_ps_ihh("起き上がり"),
		 __lib_u_everybody_plansheet_ps_ihh("座位"),
		 __lib_u_everybody_plansheet_ps_ihh("立ち上がり"),
		 __lib_u_everybody_plansheet_ps_ihh("立位"),

		 array
		 (array('Column' => '基本動作・短期目標',
			'Draw' => 'textarea',
			'Option' => array('cols' => 50, 'rows' => 6)),
		  array('Column' => '基本動作・アプローチ',
			'Draw' => 'textarea',
			'Option' => array('cols' => 50, 'rows' => 6)))
		 ),

     '活動' =>
     array_merge(array(array('Column' => "活動度",
			     'Draw' => 'text',
			     'Option' => array('size' => 50,
					       'maxlength' => 40)),
		       array('Column' => '活動度・短期目標',
			     'Draw' => 'textarea',
			     'Option' => array('cols' => 50, 'rows' => 6)),
		       array('Column' => '活動度・アプローチ',
			     'Draw' => 'textarea',
			     'Option' => array('cols' => 50, 'rows' => 6))),
		 ...
		 array
		 (array('Column' => 'セルフケア・短期目標',
			'Draw' => 'textarea',
			'Option' => array('cols' => 50, 'rows' => 6)),
		  array('Column' => 'セルフケア・アプローチ',
			'Draw' => 'textarea',
			'Option' => array('cols' => 50, 'rows' => 6))),
  ...
  $cfg['DCOLS'][] = array('Column' => '記録者名',
			  'Label' => '記録者名',
			  'Draw' => 'text');
  $select_join =
    ("\nFROM " . mx_db_sql_quote_name($cfg['TABLE']) . " AS PS\n" .
     "JOIN \"患者台帳\" AS P\n" .
     "ON P.\"ObjectID\" = PS.\"患者\" AND P.\"Superseded\" IS NULL\n" .
     "LEFT JOIN \"職員台帳\" AS E\n" .
     "ON PS.\"CreatedBy\" = E.\"userid\" AND E.\"Superseded\" IS NULL\n" .
     "LEFT JOIN \"職員台帳\" AS PD\n" .
     "ON PD.\"ObjectID\" = PS.\"主治医\" AND PD.\"Superseded\" IS NULL\n" .
     "LEFT JOIN \"職員台帳\" AS RD\n" .
     "ON RD.\"ObjectID\" = PS.\"リハ担当医\" AND RD.\"Superseded\" IS NULL\n" .
     "LEFT JOIN \"職員台帳\" AS PT\n" .
     "ON PT.\"ObjectID\" = PS.\"PT\" AND PT.\"Superseded\" IS NULL\n" .
     "LEFT JOIN \"職員台帳\" AS OT\n" .
     "ON OT.\"ObjectID\" = PS.\"OT\" AND OT.\"Superseded\" IS NULL\n" .
     "LEFT JOIN \"職員台帳\" AS ST\n" .
     "ON ST.\"ObjectID\" = PS.\"ST\" AND ST.\"Superseded\" IS NULL\n" .
     "LEFT JOIN \"職員台帳\" AS NS\n" .
     "ON NS.\"ObjectID\" = PS.\"看護師\" AND NS.\"Superseded\" IS NULL\n" .
     "LEFT JOIN \"職員台帳\" AS SW\n" .
     "ON SW.\"ObjectID\" = PS.\"SW\" AND SW.\"Superseded\" IS NULL\n");
...
class rehab_plansheet_edit extends simple_object_edit {
  var $debug = 0;
