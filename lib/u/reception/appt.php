...
WHERE NULL IS NULL',
	...
	'LLAYO' => array(array('Column'=>'À«Ì¾','Label'=>'Name'), array('Column'=>'¿¦¼ï','Label'=>'Type'), ),
...
$__ra_nondr_config = array(
	'TABLE' => 'modalities',
	'HSTMT' => '
SELECT	M.id as modality, M.name AS "Name", R.name AS "Type"
...
',
	'UNIQ_ID' => 'M.id',
	'LLAYO' => array('Name', 'Type'),
	'LIST_IDS' => array('modality', 'Name'),
);
$__ra_nondr_config['STMT'] = $__ra_nondr_config['HSTMT'];

if ($_mx_custom_nondr_appt) {
	$__ra_nondr_config['LLAYO'] = array('Name');
}
