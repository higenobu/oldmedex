...
WHERE NULL IS NULL',
	...
	'LLAYO' => array(array('Column' => "À«Ì¾", 'Label' => "name"),
			       
array('Column' => "¿¦¼ï", 'Label' => "Category"),),
			           
	'LIST_IDS' => array('modality', array('Column' => "À«Ì¾", 'Label' => "name"),)
...
',
	'UNIQ_ID' => 'M.id',
	'LLAYO' => array(array('Column' => "¼ïÊÌ", 'Label' => "category"),
			       
array('Column' => "Ì¾¾Î", 'Label' => "modalityname"), ),
	'LIST_IDS' => array('modality', array('Column' => "Ì¾¾Î", 'Label' => "modalityname"),),
);
$__ra_nondr_config['STMT'] = $__ra_nondr_config['HSTMT'];

if ($_mx_custom_nondr_appt) {
	$__ra_nondr_config['LLAYO'] = array(array('Column' => "Ì¾¾Î", 'Label' => "modalityname"),);
}
