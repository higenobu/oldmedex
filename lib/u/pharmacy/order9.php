...
//11-03-2014 changed to shot_rp_edit and shotdrugpick
include_once $_SERVER['DOCUMENT_ROOT'].'/lib/u/pharmacy/shot_rp_edit.php';
...
include_once $_SERVER['DOCUMENT_ROOT'].'/lib/u/pharmacy/pdf-shot.php';
// 
function _lib_u_sei_kiroku11() {
  ...
  $stmt = <<<SQL
    select E."ID", E."姓", E."名" , E.userid from 
	  ...
	  where
          ...
          E."Superseded" is NULL and E.userid is not null and
...
function _lib_u_pharmacy_order_cfg(&$cfg)
{
  $pt_outin = 'I';
...
class list_of_pharmacy_orders extends list_of_ppa_objects {
  function list_of_pharmacy_orders($prefix, $cfg=NULL) {
    _lib_u_pharmacy_order_cfg($cfg);
...
class pharmacy_order_display extends simple_object_display {
  function pharmacy_order_display($prefix, $cfg=NULL) {
    _lib_u_pharmacy_order_cfg($cfg);
