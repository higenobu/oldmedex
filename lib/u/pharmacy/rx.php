...
function __lib_u_pharmacy_rx_cfg(&$cfg, $opt) {
...
class list_of_pharmacy_rxs extends list_of_ppa_objects {

	var $default_row_per_page = 4;

	function list_of_pharmacy_rxs($prefix, $pid, $opt=array()) {
		$cfg = array();
		$this->pid = $pid;
		$this->setonly = $opt['SETONLY'];
		__lib_u_pharmacy_rx_cfg(&$cfg, $opt);
