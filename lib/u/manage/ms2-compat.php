...
class mx_mx2_compat extends single_table_application {
	...
	function mx_mx2_compat($config) {
		single_table_application::single_table_application();
		$this->loo = new master_select('ms2-', $config);
	}
...
function master_select_table($param, $qbe_enum=NULL, $header_fields=NULL) {
  ...
  $mx2_compat = new mx_mx2_compat($config);
  $mx2_compat->main();
}
