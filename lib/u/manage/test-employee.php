...
E."ObjectID", E."CreatedBy", "itemid",
 
E.userid, 
 
E."category",E,kanten,E.naiyou,E.testcond,E.testdate,E.testval,E.shiji
...
(
 ...
 'COLS' => array("ObjectID", "CreatedBy", "itemid",
		 kanten,naiyou,testcond,testval,testdate,
		 "category",
		 
		 ),

 'LCOLS' => array_merge(array("itemid", "kanten"),
			$_lib_u_manage_employee_ldcol_d),
 'DCOLS' => array_merge(array("itemid"),
			 
			 
			 
			),

 'ICOLS' => array('userid', "itemid",
		  ),
 'HSTMT' => $_lib_u_manage_employee_fetch_stmt,
 'STMT' => $_lib_u_manage_employee_fetch_stmt,
...
(
 ...
 '職位名' => array('cf' => $_lib_u_manage_employee_rank_cfg,
		   ...
		   'twm' => 'この職位に設定する',
		   'col' => '職位'),
 'catname' => array('cf' => $_lib_u_manage_department_cfg,
...
SQL;
  ...
  function try_commit(&$db) {
	...
	return 'failure';
      ...
      $qid = mx_db_sql_quote($this->data['itemid']);
