...
$_lib_u_manage_ms2_config = array
(
 'TABLE' => 'Medis病名マスター',
 'COLS' => array('当院採用', '病名表記', 'ICD10', 'ICD10確度'),
 'accept_name' => '当院採用',
 'LCOLS' => array
 (array('Column' => '当院採用',
	'Label' => '当院採用',
 ...
 'NOLINK' => 1,
 'ALLOW_SORT' => array
 ('病名表記' => array('病名表記' => '"病名表記"'),
  'ICD10' => array('ICD10' => '"ICD10"'),
  'ICD10確度' => array('ICD10確度' => '"ICD10確度"')),
 'ENABLE_QBE' => array
 (array('Column' => '当院採用',
	'Compare' => '当院採用',
	'Draw' => 'enum',
...
class master_select extends list_of_simple_objects {
  ...
  function master_select($prefix, $config=NULL) {
    global $_lib_u_manage_ms2_config;
    global $__uiconfig_ms_qbe_enum, $__uiconfig_ms_header_fields;

    if (is_null($config)) $config = $_lib_u_manage_ms2_config;
