...
include_once $_SERVER['DOCUMENT_ROOT'].'/lib/common.php';
 //for osato-clinic
//updated 0910-2014 newer than runnig server
//added dos 
//kk75 Rh
...
$param[$index]=mb_str_replace("所見あり","2",$inf);
//0910-2014
if (mb_substr($inf,0,1)=='所'){$param[$index]='2';}
if (mb_substr($inf,0,1)=='異'){$param[$index]='1';}
if (mb_substr($inf,0,1)==''){$param[$index]=' ';}
if (mb_substr($inf,0,1)=='N'){$param[$index]='4';}
if (mb_substr($inf,0,1)=='不'){$param[$index]='4';}
...
$params['ph1'] = "";
$params['ph2'] = "";
//0910-2014 nyouto the same
$params['kk65']=$params['kk51'];
$params['pp65']=$params['pp51'];
//0910-2014 nyouto the same
$params['aa24']=$params['aa21'];
$params['baa24']=$params['baa21'];
//
...
//0910-2014
if ($params['kk51']=='NEGATIVE'){$params['kk51']="(-)";}

if ($params['kk51']=='POSITIVE'){$params['kk51']="(+)";}
if ($params['pp51']=='NEGATIVE'){$params['pp51']="(-)";}

if ($params['pp51']=='POSITIVE'){$params['pp51']="(+)";}
