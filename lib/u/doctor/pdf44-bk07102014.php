...
/*
 $param[$index]=mb_str_replace("所見あり","Remarkable",$inf);
if (mb_substr($inf,0,1)=='所'){$param[$index]='Remarkable';}
if (mb_substr($inf,0,1)=='異'){$param[$index]='Unremarkable';}
if (mb_substr($inf,0,1)==''){$param[$index]='N/A';}
if (mb_substr($inf,0,1)=='N'){$param[$index]='N/A';}
if (mb_substr($inf,0,1)=='不'){$param[$index]='N/A';}
...
$params=appset2('k1000',$params);
$params=appset2('k1001',$params);
$params=appset2('k1002',$params);
//$params=appset2('k1003',$params);
$params=appset2('kk70',$params);

$params=appset(10,'k50',$params);
$params=appset(10,'k51',$params);
 
$params=ppset2('p520',$params);
//keidomyauchoonpa
$params=ppset2('p1002',$params);
$params=ppset2('p1000',$params);
$params=ppset2('p1001',$params);
//chol/hdl hi
//$params=ppset2('p1003',$params);
//blood type
$params=ppset2('pp70',$params);
//gantei
...
$params=ppset(10,'p50',$params);
$params=ppset(10,'p51',$params);
