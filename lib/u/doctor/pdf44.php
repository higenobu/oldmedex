...
$strall=$strall.mb_substr($inf,0,$pos1);
...
$strall=$strall.substr($inf,0,$pos2).PHP_EOL;
$inf=substr($inf,$pos2+1,$inf_len);
$pos1=strpos($inf, "[");
if ($pos1==false){
...
//nothing done 
function selecten4($inf)
{
return $inf;	
}
//
function selecten3($inf)
{
//0805-2014
...
$params['PATIENT_DOB'] = $pat['À¸Ç¯·îÆü'] ;
...
$params['PATIENT_ZIP'] = $pat['½»½ê0'];
  $params['PATIENT_ADDR1'] = $pat['½»½ê1'];
$params['PATIENT_ADDR2'] = $pat['½»½ê2'];
  $params['PATIENT_ADDR3'] = $pat['½»½ê3'];
$params['PATIENT_OCC'] = $pat['¶ÐÌ³ÀèÌ¾'];
$params['PTDEPT'] = $pat['ÀÁµáÀèÌ¾'];
$params['PTBR'] = $pat['ÀÁµáÀè½»½ê'];
//0211-2014
...
$ejboth = $ord['h12'];
//0301-2014
//using latest data as past data dynamically
$params['PREORDERDATE'] = $past['order_date'];
//1015-2014 not needed
$params['p520']=$past['k520'];
$params['pp21']=$past['kk21'];
$params['pp20']=$past['kk20'];
$params['pp22']=$past['kk22'];
$params['pp41']=$past['kk41'];
$params['pp40']=$past['kk40'];
$params['pp42']=$past['kk42'];
$params['ph1']=$past['h1'];
$params['ph2']=$past['h2'];
//not needed end
$params['baa1000']=$past['aa1000'];
$params['baa1001']=$past['aa1001'];
$params['baa1002']=$past['aa1002'];
$params['baa1003']=$past['aa1003'];
//pastdata for ssXX 10-20-2014
$kk=0;
 for ($kk=0;$kk<10;$kk++)
{ 
$aindex="ss".$kk;
$bindex="bss".$kk;
$params[$bindex]=$past[$aindex];
 }
$kk=0;
 for ($kk=0;$kk<10;$kk++)
{
...
$params["bc1002"]=$past["c1002"];
$params["bc560"]=$past["c560"];
//
//japanese templates
if ($ejboth=='1'){
...
$index="c50".$kk;
$pindex="bc50".$kk;
$params[$pindex]=selectjp($past[$index]);
 }
$kk=0;
 for ($kk=0;$kk<6;$kk++)
{
...
$params["bc1002"]=selectjp($past["c1002"]);
$params["bc560"]=selectjp($past["c560"]);
//for past data
//
$kk=0;
 for ($kk=0;$kk<10;$kk++)
...
$inf=$past['c560'];
$params['d560']=selectjp($inf);
 

$inf=$past['c561'];
$params['d561']=selectjp($inf);
$inf=$past['cc0'];
 
$params['dd0']=selectjp($inf);
//
 
$inf=$past['notes'];
 
$params['ddnotes']=selectjp($inf);
//
//
...
$params['dd1']=selectjp($inf);
//
//
$inf=$past['special_req'];
 
$params['ddspecial_req']=selectjp($inf);
//
$inf=$past['c1002'];
 
$params['d1002']=selectjp($inf);
//
//
} //end of japanese report


//

//10-14-2014
//for both(special english) nothing select english of summary etc
//use osato6.ods
if ($ejboth=='3'){
...
$params['e15']=$value[5];
//
// $params['ss0']='="'.$value[0].'"'."&CHAR(10)&".'"'.$value[1].'"'."&CHAR(10)&".'"'.$value[2].'"'."&CHAR(10)&".'"'.$value[3].'"'."&CHAR(10)&".'"'.$value[4].'"';
//
$inf=$params['ss1'];
 $value=selecten3($inf);
//$value=$inf;
...
$params['e10']=$value[5];
//
// $params['ss1']='="'.$value[0].'"'."&CHAR(10)&".'"'.$value[1].'"'."&CHAR(10)&".'"'.$value[2].'"'."&CHAR(10)&".'"'.$value[3].'"'."&CHAR(10)&".'"'.$value[4].'"';
//
$inf=$params['notes'];
 $value=selecten3($inf);
//$value=$inf;
...
$params['e05']=$value[5];
//
// $params['notes']='="'.$value[0].'"'."&CHAR(10)&".'"'.$value[1].'"'."&CHAR(10)&".'"'.$value[2].'"'."&CHAR(10)&".'"'.$value[3].'"'."&CHAR(10)&".'"'.$value[4].'"';
...
$params['e25']=$value[5];
//
// $params['special_req']='="'.$value[0].'"'."&CHAR(10)&".'"'.$value[1].'"'."&CHAR(10)&".'"'.$value[2].'"'."&CHAR(10)&".'"'.$value[3].'"'."&CHAR(10)&".'"'.$value[4].'"';
...
$params['e20']=$value[4];
//
// $params['cc0']='="'.$value[0].'"'."&CHAR(10)&".'"'.$value[1].'"'."&CHAR(10)&".'"'.$value[2].'"'."&CHAR(10)&".'"'.$value[3].'"';
//
...
$params[$index]=selecten($inf);
 ...
 $params['PATIENT_SEX'] = $pat['À­ÊÌ'] == 'M' ? 'Male' : 'Female';
//
//for past data
//10-10-2014
$kk=0;
...
$index="c50".$kk;
$pindex="bc50".$kk;
$params[$pindex]=selecten($past[$index]);
 }
$kk=0;
 for ($kk=0;$kk<6;$kk++)
{
...
$params["bc1002"]=selecten($past["c1002"]);
$params["bc560"]=selecten($past["c560"]);
//for past data
//
$kk=0;
 for ($kk=0;$kk<10;$kk++)
...
$inf=$past['c560'];
$params['d560']=selecten($inf);
 

$inf=$past['c561'];
$params['d561']=selecten($inf);
$inf=$past['cc0'];
 
$params['dd0']=selecten4($inf);
//
 
$inf=$past['notes'];
 
$params['ddnotes']=selecten($inf);
//
//
...
$params['dd1']=selecten($inf);
//
//
$inf=$past['special_req'];
 
$params['ddspecial_req']=selecten($inf);
//
$inf=$past['c1002'];
 
$params['d1002']=selecten($inf);
...
//above for special engish-only

 	
//for english or long-english

if ($ejboth=='2' || $ejboth=='4'){
//for past data
//10-10-2014
$kk=0;
 for ($kk=0;$kk<9;$kk++)
...
//above for engish or long english
...
if ($ejboth=='3')
$params['TEMPLATE'] = "osato6.ods";
if ($ejboth=='4')
$params['TEMPLATE'] = "osato4.ods";
