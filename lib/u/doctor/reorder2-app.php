...
function collect_patients2($group_limit, $date_from, $date_to,
				  $options) {
		return index_pt_collect_patients2($group_limit,
						 $date_from,
						 $date_to,
						 $this->app_ix_name,
						 $options);
...
//0723-2012 collect_patients2
		$this->patient = $this->collect_patients2($group_limit,
							 $date_from,
							 $date_to,
							 $options);
