...
class pharma_approve2_application extends reorder_application {
	...
	function pharma_approve2_application() {
	...
	function check_approvals() {
		...
		$oid = array();
		$ref = $this-> approve2_references;
		$store = $this-> approve2_stores;
