...
function get_insident ($oid, $shots=NULL) {
  $con = mx_db_connect();
  

//03-13-2011
    $str = 'select "ID", "ObjectID", "Superseded", "CreatedBy", reportdate, factdate, 
       "患者", factloc, facttype, busho, empnm1, empnm2, 
       pnm1, pnm2,factcont, factdone, factplan, factdo,proof
  from  insident
...
//03-13-2011
    $str = 'select "ObjectID" as oid, 
                 orderdate, plandate,  "患者",  bui1, bui2, bui3, memo21, memo12, memo1, memo11, memo22
