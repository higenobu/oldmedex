...
function go_pdfe($oid, $shots, $template=NULL) 
{
...
$params[$index]=mb_str_replace("所見あり","Unremarkable",$inf);
if (mb_substr($inf,0,1)=='異'){$params[$index]='Remarkable';}
if (mb_substr($inf,0,1)==''){$params[$index]='N/A';}
