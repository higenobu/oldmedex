...
//1120-2012 yoko ni button naraberu
$j=0;
 	print "<div class=\"appbar-all\">";
	foreach ($top_apps as $app) {
		$path = $app[0];
		...
		//$target = $app[3] ? ' target="_blank"': '';
			...
			$target=' ';
// show application button if name top is * or +
/* 
if ($j > 8) { 
print "</div>";
print "<div class=\"appbar-all\">";
...
//0617-2014 add $name to class
		print '<a  '." href=\"$path\"${target} class=\"appbar-anc\">";
//11-01-2014
		print htmlspecialchars(mb_substr($abbrev,0,5));
		print "</a\n></div>";
...
$thislink=$path.$target;
//print $thislink;
//11-10-2014 do not use autorefresh
/*
print '
<script type="text/JavaScript">

function AutoRefresh() {
	setTimeout("callit();", 8000);}';
print 'function callit(){';

print 'document.location="'.$thislink.'";}';
//print '
//  window.open("'.$thislink.'");}';

//print '
//	document.getElementsByClassName("';
//print 'appbar-anc'.'"'.")[0].click();";
//print $path.$target.'"'.").click();";
//print '}'
print '
</script>';
