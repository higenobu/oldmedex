...
(
	...
	'ENABLE_QBE' => array(array('Column' => '´µ¼ÔID','Label' => "PID",
			      ...
			      array('Column' => '¼ç¼£°å',
				    ...
				    'Singleton' => 1,
				    'Enum' => 'lazy'),
			      array('Column' => 'Í½ÌóÀè','Label' => 'Reserve',
				    'Draw' => 'enum',
				    'Singleton' => 1,
				    'Enum' => 'lazy'),
			      array('Column' => '²ÊÌÜ',
	...
	'LCOLS' => array(
			 ...
			 array('Column' => "¼õÉÕ»þ¹ï",'Label' => "checkintime",
			       ...
			       'Option' => array('to-seconds' => 0,
						 'Class' => 'nowrap')),
			 array('Column' => "Á°²óÍè±¡»þ¹ï",'Label' => 'pre-visit',
			       'Draw' => 'timestamp',
			       'Option' => array('to-seconds' => 0,
						 'Class' => 'nowrap')),
			 array('Column' => "Í½Ìó»þ¹ï",'Label' => "reservedtime",
			       'Draw' => 'timestamp',
			       'Option' => array('to-seconds' => 0,
						 'Class' => 'nowrap')),
			 //array('Column' => '²ÊÌÜÌ¾',
...
if ($_mx_use_dept_in_reception) {
	...
	$__ppa_checkin_list_cfg['LLAYO'] =
		_lib_so_zip_layo($__ppa_checkin_list_cfg['LCOLS'], array
				 ('Í½Ìó»þ¹ï',
				  ...
				  '»ñ¸»',
				  'ÌÜÅª', $__status));
	$__ppa_cil_eqbe = array('´µ¼ÔID', '¥Õ¥ê¥¬¥Ê', 'Ç¯Îð', 'Í½ÌóÀè');
} else {
	$__ppa_checkin_list_cfg['LLAYO'] =
		_lib_so_zip_layo($__ppa_checkin_list_cfg['LCOLS'], array
	...
	$__ppa_cil_eqbe = array('´µ¼ÔID', '¥Õ¥ê¥¬¥Ê',
				'À­ÊÌ', 'Ç¯Îð', 'Í½ÌóÀè');
}
if ($_mx_use_checked_in_patient_status) {
...
//0815-2011
  function application_name() {
	  if ($this->encounter_mode == 'I')
		  return $this->auth[1] . ' (Æþ±¡)';
	  else if ($this->encounter_mode == 'O')
		  return $this->auth[1] . ' (³°Íè)';
	  else
		  return $this->auth[1];
  }
  ...
  function top_pane() {
    ...
    if ($this->lop) {
		...
		mx_titlespan($this->lop->list_name . '¤«¤éÁªÂò');
